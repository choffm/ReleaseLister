...
public final class ReleaseLister extends javax.swing.JFrame {
    ...
    private ReleaseLister() {
        okIcon = new ImageIcon(ReleaseLister.class.getResource("/cc/de1/v/releaselister/images/oksmall.jpg"));
        errorIcon = new ImageIcon(ReleaseLister.class.getResource("/cc/de1/v/releaselister/images/badsmall.jpg"));
        Image logo = new ImageIcon(ReleaseLister.class.getResource("/cc/de1/v/releaselister/images/releaseLister.jpg")).getImage();        
        setIconImage(logo);
